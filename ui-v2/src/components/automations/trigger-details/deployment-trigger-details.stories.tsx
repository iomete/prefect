...
import {
	...
	DeploymentTriggerDetails,
} from "./deployments-trigger-details";
...
const meta = {
	title: "Components/Automations/DeploymentTriggerDetails",
	component: StoryComponent,
	decorators: [routerDecorator],
} satisfies Meta<typeof DeploymentTriggerDetails>;
	...
	return (
		<div className="flex flex-col gap-4">
			{[
				...
				<DeploymentTriggerDetails key={i} trigger={trigger} />
			))}
		</div>
	);
}
